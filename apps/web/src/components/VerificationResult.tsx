                            ...
                            {labels.length > 0 && (
                                <div className="mt-5 flex flex-wrap gap-2">
                                    {labels.map((labelText, index) => (
                                        <span
                                            className="rounded-full bg-neutral-300/60 px-3 py-1 font-medium text-gray-700 text-sm transition-all duration-150 ease-in-out select-none"
                                            key={`${labelText}-${index}`}>
                                            {labelText}
                                        </span>
                                    ))}
                        ...
                        <Card className="p-4 bg-white">
                            <div className="flex items-center justify-between">
                                ...
                                <Button
                                    ...
                                    size="icon"
                                    className="text-foreground bg-white hover:bg-neutral-200/60 cursor-pointer shadow-none">
                            ...
                            <section>
                                ...
                                <div className="flex flex-col gap-2">
                                    {source.map((sourceItem, index) => {
                                        ...
                                        const sourceTitle =
                                            sourceItem.title || sourceDomain;

                                        return (
                                            <a
                                                className="source-item outline outline-neutral-200/60 bg-white group flex items-center relative rounded-md px-2 py-2 ms-2 ps-5 transition-all duration-300 ease-in-out hover:scale-[1.1] hover:bg-[var(--color-foreground)] hover:shadow-sm active:scale-[0.99]"
                                                href={sourceItem.url}
                                                key={sourceItem.id}
                                                rel="noopener noreferrer"
                                                style={{
                                                ...
                                                target="_blank">
                                                <div className="absolute shrink-1 left-[-.6rem] flex items-center justify-center">
                                                    <div className="inline-flex h-5 w-5 items-center justify-center rounded-lg bg-white outline-3 outline-[#f1f1f0] font-semibold text-foreground text-sm transition-all duration-300 ease-out group-hover:scale-110 group-hover:bg-white group-hover:text-foreground group-hover:shadow-md group-hover:outline-neutral-200/60">
                                                        {index + 1}
                                                    </div>
                                                </div>

                                                <div className="flex items-center gap-3 w-full truncate text-ellipsis">
                                                    <FaviconImage
                                                        alt=""
                                                        domain={sourceDomain}
                                                    ...
                                                    <div className="flex flex-col w-full truncate ">
                                                        <div className="font-semibold text-foreground text-sm transition-all duration-200 group-hover:text-white text-ellipsis overflow-hidden">
                                                            {sourceTitle}
                                                        </div>
