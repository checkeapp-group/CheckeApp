    ...
    return (
        <>
            ...
            <div className="flex min-h-screen flex-col">
                <header className="sticky top-0 z-50 w-full border-border border-b bg-white/95 backdrop-blur-sm shadow-sm">
                    <div className="container mx-auto flex h-16 items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            <nav className="hidden items-center gap-1 md:flex">
                                <Link
                                    href="/"
                                    className="p-3 transition-all hover:bg-neutral-200/60 rounded-lg">
                                    {t("nav.verify")}
                                </Link>
                                {isAuthenticated && (
                                    <>
                                        <Link
                                            href="/verifications"
                                            className="py-3 px-2 transition-all hover:bg-neutral-200/60 rounded-lg">
