...
export default function VerificationResult({ data }: VerificationResultProps) {
  ...
  return (
    <div className="relative w-full">
      <div className="absolute top-[-15vw] left-0 z-1 h-[40vw] w-full overflow-hidden lg:top-[-20vw] xl:top-[-32vw]">
        <Image
          alt={
      ...
      <div className="relative mx-auto max-w-6xl overflow-hidden bg-background p-4 font-sans text-foreground sm:p-6 lg:p-8">
        <div className="mb-6">
              ...
              {labels.length > 0 && (
                <div className="mt-5 flex flex-wrap gap-2">
                  {labels.map((labelText, index) => (
                    <span
                      className="rounded-full border border-primary/20 bg-gray-100 px-3 py-1 font-medium text-gray-700 text-sm shadow-sm transition-all duration-150 ease-in-out hover:bg-gray-200 hover:text-gray-900"
                      key={`${labelText}-${index}`}
                    >
                      {labelText}
                    </span>
