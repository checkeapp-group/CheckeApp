                    ...
                    <div className="space-y-8">
                        ...
                        {source.length > 0 && (
                            <section>
                                ...
                                <div className="flex flex-col gap-2">
                                    {source.map(
                                        (sourceItem: any, index: number) => {
                                            const sourceDomain =
                                                sourceItem.domain ||
                                                new URL(sourceItem.url)
                                                    .hostname;
                                            const sourceTitle =
                                                sourceItem.title ||
                                                sourceDomain;
                                            ...
                                            return (
                                                <a
                                                    className="source-item group relative ms-2 flex items-center rounded-md bg-white px-2 py-2 ps-5 outline outline-neutral-200/60 transition-all duration-300 ease-in-out hover:scale-[1.03] hover:bg-[var(--color-foreground)] hover:shadow-sm active:scale-[0.99]"
                                                    href={sourceItem.url}
                                                    key={sourceItem.id}
                                                    rel="noopener noreferrer"
                                                    style={{
