...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md font-medium text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-primary text-primary-foreground hover:bg-success',
        destructive: 'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline:
          'border border-input bg-background hover:bg-success/10 hover:text-success-foreground',
        secondary: 'bg-neutral text-neutral-foreground hover:bg-success/20',
        ghost: 'hover:bg-success/10 hover:text-success-foreground',
        link: 'text-info underline-offset-4 hover:text-info/80 hover:underline',
