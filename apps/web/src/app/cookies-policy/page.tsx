          ...
          >
            ...
            <section className="space-y-8">
              <div>
                ...
                <p className="text-[var(--color-text)]">{t("cookies.intro.text")}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-[var(--color-text)]">{t("cookies.whatAre.text")}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-[var(--color-text)]">{t("cookies.types.text")}</p>
              ...
              <div>
                ...
                <p className="text-[var(--color-text)]">{t("cookies.security.text")}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-[var(--color-text)]">{t("cookies.rights.intro")}</p>
                <ul className="ml-6 list-disc space-y-2">
                  <li className="text-[var(--color-text)]">{t("cookies.rights.clearInfo")}</li>
                  <li className="text-[var(--color-text)]">{t("cookies.rights.manage")}</li>
              ...
              <div>
                ...
                <p className="text-[var(--color-text)]">{t("cookies.updates.text")}</p>
              </div>
