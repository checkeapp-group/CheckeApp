...
const TextInputForm = ({
  ...
  return (
    <>
      ...
      <Card
        className={`rounded-3xl border-2 border-transparent p-4 transition-all duration-300 sm:p-6 ${
      ...
      >
        <div className="relative">
          <div className="flex h-0 w-full justify-center">
            <div className="absolute top-[-2.5rem] w-max overflow-hidden rounded-full bg-gradient-to-br from-[#83d59a] via-[#2fbe9a] to-[#04abd0] p-1 px-3 outline outline-neutral-200/60">
              <div className="flex items-center justify-center gap-2">
                <Image
                  ...
                  src={LatxaIcon}
                />
                <div className="font-medium text-white text-xs uppercase">
                  Powered by <span className="font-bold">LATXA</span>
                </div>
              </div>
            </div>
          </div>
