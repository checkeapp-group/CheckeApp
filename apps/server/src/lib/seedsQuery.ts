...
const seedData: SeedData = {
  ...
  verifications: [
    {
      originalText:
        'Climate change is a natural phenomenon and not caused by human activities. The earth has always gone through natural climate cycles.',
      status: 'completed',
    },
    {
    ...
    {
      originalText:
        '5G networks cause cancer and other serious health problems including weakening the immune system.',
      status: 'processing_questions',
    },
    {
      originalText:
        'Eating organic food is significantly healthier than conventionally grown food.',
      status: 'generating_summary',
    },
    {
      originalText:
        'Electric cars are worse for the environment than gasoline cars due to battery production.',
      status: 'draft',
    },
    {
  ...
  criticalQuestions: [
    {
      questionText:
        'What does the scientific consensus say about the primary causes of climate change?',
      originalQuestion:
        'What does the scientific consensus say about the primary causes of climate change?',
      orderIndex: 0,
    },
    {
      questionText:
        'What evidence exists for human activities contributing to climate change versus natural cycles?',
      originalQuestion:
        'What evidence exists for human activities contributing to climate change versus natural cycles?',
      orderIndex: 1,
    },
    ...
    {
      questionText:
        'What peer-reviewed studies exist on COVID-19 vaccine effects on fertility and DNA?',
      originalQuestion:
        'What peer-reviewed studies exist on COVID-19 vaccine effects on fertility and DNA?',
      orderIndex: 1,
    },
    {
      ...
      originalQuestion:
        'What evidence was presented in courts regarding 2020 election fraud claims?',
      orderIndex: 0,
    },
    {
      questionText:
        'What do election security experts and officials say about the 2020 election integrity?',
      originalQuestion:
        'What do election security experts and officials say about the 2020 election integrity?',
      orderIndex: 1,
    },
    {
      questionText:
        'What does the scientific research say about 5G radiation levels compared to safety standards?',
      originalQuestion:
        'What does the scientific research say about 5G radiation levels compared to safety standards?',
      orderIndex: 0,
    },
  ...
  sources: [
    {
      ...
      summary:
        'The most comprehensive scientific assessment of climate change, confirming human activities as the dominant cause.',
      domain: 'ipcc.ch',
      isSelected: true,
    },
    {
      ...
      summary:
        "NASA's comprehensive evidence for climate change including temperature records and greenhouse gas data.",
    ...
    },
    {
      ...
      summary:
        'Official CDC information about how COVID-19 vaccines work and their safety profile.',
      domain: 'cdc.gov',
      isSelected: true,
    },
    {
      ...
      summary:
        'Peer-reviewed research on COVID-19 vaccine efficacy and safety from clinical trials.',
      domain: 'nejm.org',
      isSelected: true,
    },
    {
...
async function seedVerifications(userIds: string[]): Promise<string[]> {
  ...
  for (let i = 0; i < seedData.verifications.length; i++) {
    try {
      ...
      console.log(
        `✅ Created verification (${verification.status}): ${verification.originalText.substring(0, 60)}...`
      );
    } catch (error) {
  ...
  const finalResults = [
    {
      ...
      citationsJson: JSON.stringify([
        ...
        },
        {
          ...
          url: 'https://climate.nasa.gov/evidence/',
          relevantQuote:
            'Multiple studies show 97% of climate scientists agree current warming is primarily human-caused.',
        },
      ]),
      answersJson: JSON.stringify([
        {
          ...
          question:
            'What does the scientific consensus say about the primary causes of climate change?',
          answer:
            '97% of actively publishing climate scientists agree that human activities are the primary cause of recent climate change.',
        },
        {
          questionId: 'q2',
          question:
            'What evidence exists for human activities contributing to climate change versus natural cycles?',
          answer:
            'Multiple lines of evidence including isotopic analysis of atmospheric CO2, correlation with industrial emissions, and climate models that only match observed warming when human factors are included.',
        },
      ]),
    },
    {
      finalText:
        'VERDICT: FALSE. COVID-19 mRNA vaccines do not alter human DNA or cause infertility. mRNA vaccines work by providing instructions to cells to produce a protein that triggers an immune response, but the mRNA never enters the cell nucleus where DNA is stored. Extensive clinical trials and real-world data show no evidence of fertility effects, and millions of pregnancies have occurred safely after vaccination.',
      ...
      citationsJson: JSON.stringify([
        {
          ...
          url: 'https://www.cdc.gov/coronavirus/2019-ncov/vaccines/facts.html',
          relevantQuote:
            'mRNA vaccines do not contain the live virus and cannot change or interact with your DNA in any way.',
        },
        {
          id: '4',
          ...
          url: 'https://www.nejm.org/covid-vaccine',
          relevantQuote:
            'Clinical trials showed no adverse effects on fertility, and pregnancy outcomes remain normal post-vaccination.',
        },
      ]),
      answersJson: JSON.stringify([
        {
          ...
          answer:
            'mRNA vaccines deliver genetic instructions to cells to produce the spike protein, which triggers immune response. The mRNA is degraded quickly and never enters the nucleus containing DNA.',
        },
        {
          questionId: 'q4',
          question:
            'What peer-reviewed studies exist on COVID-19 vaccine effects on fertility and DNA?',
          answer:
            'Multiple large-scale studies including clinical trials with 44,000+ participants show no fertility effects. No mechanism exists for mRNA to alter DNA.',
        },
      ]),
    },
  ];
...
async function verifySeeding(): Promise<void> {
  ...
  try {
    ...
    const statusCount = await executeRawQuery(
      'SELECT status, COUNT(*) as count FROM verification GROUP BY status'
    );
