        ...
        <section className="relative z-10 w-full px-6 py-10 sm:px-8 lg:px-12">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <p className="text-[var(--color-text)]">{t("about.paragraph2")}</p>

              <p className="text-[var(--color-text)]">{t("about.paragraph3")}</p>

              <p className="text-[var(--color-text)]">{t("about.paragraph4")}</p>
            </div>
          </article>
        </section>
      </main>
