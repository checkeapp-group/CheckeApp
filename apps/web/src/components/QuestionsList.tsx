...
export default function QuestionsList({
    ...
    const refineMutation = useMutation({
        ...
        onError: (error) => {
            toast.error(
                t("questions_edit.refined_error", {error: error.message})
            );
        },
    });
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex gap-2 mt-2">
                            <Input
                                ...
                                placeholder={t(
                                    "questions_edit.refine_placeholder"
                                )}
                                value={refinementText}
                            />
                            <Button
                                disabled={
                                    isLocked || refinementText.trim().length < 5
                                }
                                onClick={() =>
                    ...
                    <Card className="border-primary/50 p-4">
                        <div className="space-y-3">
                            <Input
                                ...
                                placeholder={t(
                                    "questions_edit.new_question_placeholder"
                                )}
